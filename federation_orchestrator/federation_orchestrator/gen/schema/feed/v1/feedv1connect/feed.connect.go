...
import (
	...
	context "context"
	errors "errors"
	v1 "federation_orchestrator/gen/schema/feed/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	FeedServiceName = "schema.feed.v1.FeedService"
)
...
const (
	...
	FeedServiceGetFeedProcedure = "/schema.feed.v1.FeedService/GetFeed"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	feedServiceServiceDescriptor       = v1.File_schema_feed_v1_feed_proto.Services().ByName("FeedService")
	feedServiceGetFeedMethodDescriptor = feedServiceServiceDescriptor.Methods().ByName("GetFeed")
)

// FeedServiceClient is a client for the schema.feed.v1.FeedService service.
type FeedServiceClient interface {
	GetFeed(context.Context, *connect.Request[v1.GetFeedRequest]) (*connect.Response[v1.GetFeedResponse], error)
}

// NewFeedServiceClient constructs a client for the schema.feed.v1.FeedService service. By default,
...
// GetFeed calls schema.feed.v1.FeedService.GetFeed.
...
// FeedServiceHandler is an implementation of the schema.feed.v1.FeedService service.
...
func NewFeedServiceHandler(svc FeedServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/schema.feed.v1.FeedService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFeedServiceHandler) GetFeed(context.Context, *connect.Request[v1.GetFeedRequest]) (*connect.Response[v1.GetFeedResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("schema.feed.v1.FeedService.GetFeed is not implemented"))
}
